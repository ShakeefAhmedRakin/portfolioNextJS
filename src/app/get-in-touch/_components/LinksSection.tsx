...
export default function LinksSection() {
  return (
    <>
      <div className="flex justify-start items-start flex-col h-full  space-y-5 text-primary">
        ...
        {/* SOCIAL LINKS */}
        <div className="flex justify-center items-start flex-1 flex-wrap mt-6 gap-4 md:gap-x-6 lg:gap-x-10 gap-y-1 text-[20px] xl:text-3xl">
