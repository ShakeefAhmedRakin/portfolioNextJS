...
isOngoing: false
workId: null
excerpt: A full-stack MERN capstone project that connects blood donors, recipients, and volunteers through a role-based platform. Implements real-world payment processing via Stripe, JWT-secured APIs, and real-time request management with Firebase authentication.
---
