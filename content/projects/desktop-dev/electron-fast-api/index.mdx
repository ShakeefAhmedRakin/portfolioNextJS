...
subTitle: Open-source boilerplate for cross-platform desktop apps
...
isOngoing: false
workId: null
excerpt: An open-source template for building cross-platform desktop apps using Electron, React + TypeScript, TailwindCSS, shadcn/ui, and a FastAPI backend bundled with PyInstaller. Born from production patterns used in the HOLOS-EU project at Prudence College Dublin. Supports Windows and macOS.
---
